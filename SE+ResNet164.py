...
class BasicBlock(torch.nn.Module):
    ...
    def forward(self,input):
        ...
        w = torch.nn.functional.relu(self.dropout(self.fc1(w)))
...
def main():
    ...
    ckpt_path = '/home/zdw/docs/model_ResNet163'
    log_dir = '/home/zdw/docs/model_ResNet163'
    # model
    if resume:
    ...
    train_loader = DataLoader(
        datasets.CIFAR100(root='/home/zdw/data/CIFAR-100', train=True, download=True,transform=
                         transforms.Compose([
    ...
    test_loader = DataLoader(
        datasets.CIFAR100(root='/home/zdw/data/CIFAR-100', train=False,
